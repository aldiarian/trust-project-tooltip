            ...
            if ( evnt.target.classList.contains("info-trust__button") || evnt.target.tagName === "rect" || evnt.target.tagName === "path") {
                ...
                switch (tooltip.dataset.position) {
                    case "bottom":
                        ...
                        console.log("buton x:"+infoButtonPosition.x);
                        console.log("resto: "+ (infoButton.offsetWidth - tooltip.offsetWidth)/2 );
                        console.log("tooltip left: " + tooltip.style.left);
                    ...
                    case "top":
                        ...
                        tooltip.style.left  = infoButtonPosition.x + (infoButton.offsetWidth - tooltip.offsetWidth)/2  + "px";
                        tooltip.style.top  = ((infoButtonPosition.y - tooltip.offsetHeight)  + "px" );
                        break;
                    case "left":
                        //posiciono el mensaje a la drch del botón
                        tooltip.style.left  =( infoButtonPosition.x - tooltip.offsetWidth)  + "px";
                    ...
                    case "right":
                        ...
                        tooltip.style.left  =  infoButtonPosition.x + infoButtonPosition.width   + "px";
                        tooltip.style.top  = ((infoButtonPosition.y -( tooltip.offsetHeight /2) ) + infoButtonPosition.height/2  + "px" );
                        break;
                    default:
                        break;
                ...
                if (mq.matches) {
                    if( infoButtonPosition.x < (tooltip.offsetWidth / 2) ){
                        tooltip.style.left = "10px";
                        tooltip.classList.add("ue-c-tooltip-trust--no-arrow");
                    }
                } 
